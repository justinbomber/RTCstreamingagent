...
dict_token2source={}
online_dict={}
clientgroup=["ddsagent","nchcai","client","admin"]
token = set()
#pid480={}
...
async def handle_websocket(websocket, path):
    ...
    try:
        ...
        while True:
            ...
            print(client_id+":")
            print(message)
            if online_dict[client_id]==clientgroup[2]:
                ...
                if message.get("resolution") == "480" and dict480.get(message.get("partition_device"))==None:
                    ...
                    await clients[ddsagent].send(json.dumps(message))
            elif online_dict[client_id]==clientgroup[0]:
                ...
                if typestring=="disconnected":
                    ...
                    try:
                        ...
                        print("error: "+message)
            elif online_dict[client_id]==clientgroup[1]:
                print("NCHCAI:")
                print(message)
                tokenstring=message.get("token")
                ...
                if tokenstring not in clients:
                    ...
                    if client_id in clients:
                        ...
                        try:
                            ...
                            print("error: "+message)
            elif online_dict[client_id]==clientgroup[3]:
